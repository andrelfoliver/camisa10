...
export const translations = {
  pt: {
    ...
    nav_retro: 'Retrô',
    top_bar_announcement: '⚡ Entrega Rápida no Canadá | Em até 24h em Calgary se disponível',
    nav_admin: 'Admin',
  ...
  en: {
    ...
    nav_retro: 'Retro',
    top_bar_announcement: '⚡ Fast Delivery in Canada | Within 24h in Calgary if available',
    nav_admin: 'Admin',
