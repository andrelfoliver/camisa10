...
export const translations = {
  pt: {
    ...
    hero_satisfied_clients: '⭐ +350 clientes satisfeitos no Canadá & EUA',
    ...
    checkout_pickup_alert: 'Você escolheu Retirada em Wolf Willow (Sul de Calgary). O endereço completo será enviado após a aprovação do pedido.',
  ...
  en: {
    ...
    hero_satisfied_clients: '⭐ +350 satisfied customers in Canada & US',
    ...
    checkout_pickup_alert: 'You chose Pickup at Wolf Willow (South Calgary). The complete address will be sent after order approval.',
