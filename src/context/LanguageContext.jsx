...
export const translations = {
  pt: {
    ...
    top_bar_announcement: '⚡ Envio Rápido para Canadá & EUA',
    nav_admin: 'Admin',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: '10 a 15 dias corridos após o envio da mercadoria. Camisas personalizadas podem levar 1-2 dias a mais. Você recebe código de rastreio por email assim que o pedido é despachado.'
      },
      {
    ...
    checkout_pickup_alert_text: 'A retirada em Wolf Willow (Sul de Calgary) só ocorre mediante confirmação prévia de disponibilidade de estoque local. O endereço completo será enviado somente após a aprovação do pedido.',
  ...
  en: {
    ...
    nav_nba: 'NBA',
    nav_streetwear: 'Streetwear',
    top_bar_announcement: '⚡ Fast Shipping to Canada & US',
    nav_admin: 'Admin',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: '10 to 15 calendar days after the order is shipped. Customized jerseys may take 1-2 days longer. You will receive a tracking code by email as soon as the order is shipped.'
      },
      {
    ...
    checkout_pickup_alert_text: 'Pickup at Wolf Willow (South Calgary) is only available upon prior confirmation of local stock availability. The complete address will be sent only after order approval.',
