...
export async function migrateTeamsToSupabase() {
    ...
    const highQualityTeams = [
        // Brasileiros (Arquivos Locais - Recuperados e Estáveis)
        ...
        // Brasileiros (CDN Globo com Proxy - Alta Resiliência)
        { name: 'Atlético-GO', league: 'Brasileirão', logo: 'https://images.weserv.nl/?url=s.glbimg.com/es/sde/f/equipes/2020/07/02/atletico-go_60x60.png&w=150' },
        { name: 'Cuiabá', league: 'Brasileirão', logo: 'https://images.weserv.nl/?url=s.glbimg.com/es/sde/f/equipes/2014/04/14/cuiaba_60x60.png&w=150' },
        { name: 'Fortaleza', league: 'Brasileirão', logo: 'https://images.weserv.nl/?url=s.glbimg.com/es/sde/f/equipes/2018/03/10/fortaleza_60x60.png&w=150' },
        { name: 'Juventude', league: 'Brasileirão', logo: 'https://images.weserv.nl/?url=s.glbimg.com/es/sde/f/equipes/2014/04/14/juventude_60x60.png&w=150' },
